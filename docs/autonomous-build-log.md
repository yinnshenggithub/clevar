...
- **Open / next:** associations build (awaits §11 answers), W13 teams/routing, W14 RBAC, W15 chunk2 polish. All 3 UI/agent features build-green + deployed + smoke-verified.
